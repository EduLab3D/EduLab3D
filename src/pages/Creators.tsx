  ...
  return (
    <div className="experiments-page page-enter">
      <header className="experiments-page__hero" style={{ maxWidth: '800px' }}>
        <p className="experiments-page__eyebrow">The Team</p>
        <h1>Meet the minds behind the lab.</h1>
        <p className="experiments-page__lede">
          EduLab3D is brought to you by passionate developers dedicated to making science education accessible and engaging.
        </p>
      </header>
        ...
        <article className="experiment-card" style={{ minHeight: 'auto' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.2rem', marginBottom: '1rem' }}>
            ...
            <div>
              ...
              <span className="experiment-card__level level-advanced" style={{ display: 'inline-block', marginTop: '0.5rem' }}>UI Developer</span>
            </div>
          </div>
          <p style={{ marginBottom: '1.5rem' }}>
            Crafting the visual experience and interface. Dedicated to making the lab intuitive, responsive, and beautiful for every student.
          </p>
